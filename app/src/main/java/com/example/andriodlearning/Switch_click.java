...
public class Switch_click extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_switch_click);
        // initiate view's
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "Switch1 :" + statusSwitch1 + "\n" + "Switch2 :" + statusSwitch2, Toast.LENGTH_SHORT).show(); // display the current state for switch's
            }
        });

    }
    public void switch_src(View v){
        Intent i = new Intent(this,Switch_webview.class);
        startActivity(i);
    }
